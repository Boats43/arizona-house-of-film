...
const ROUTES = [
  ...
  '/blog/security-window-film-phoenix-cost-guide',
  ...
  '/blog/enerlogic-window-film-arizona-review',
  '/blog/residential-window-tinting-scottsdale-az-guide',
  '/blog/commercial-window-tinting-cost-phoenix-2026',
  '/blog/nexfil-onyva-ir90-arizona-review',
  ...
  '/blog/residential-performance-window-film-phoenix',
  '/blog/commercial-performance-window-film-phoenix',
  '/blog/nexfil-window-film-arizona-review',
  '/blog/window-tinting-goodyear-az-guide',
  '/blog/one-way-window-film-day-and-night-guide',
  '/blog/window-tinting-avondale-az-guide',
  '/blog/security-window-film-schools-arizona',
  ...
  '/service-areas/scottsdale', '/service-areas/surprise',
  '/service-areas/goodyear', '/service-areas/tucson', '/service-areas/flagstaff',
  '/service-areas/prescott', '/service-areas/yuma',
  '/service-areas/buckeye', '/service-areas/san-tan-valley',
  ...
  '/service-areas/sun-city-west', '/service-areas/sun-lakes',
  ...
  '/countertop-protection-film-nationwide',
  '/hurricane-window-film-arizona',
  ...
  '/privacy-film-sliding-glass-door',
  '/solyx-bird-safety-film',
  '/window-film-distributor-phoenix',
  '/ai-window-film-estimator',
  '/window-film-faq',
  '/window-film-comparison',
  '/window-film-resource-hub',
...
const PATTERN_MAP = [
  ...
  ['/films/security-films',                '/src/pages/films/SecurityFilmPage.jsx'],
  ...
  ['/brands/llumar',                        '/src/pages/brands/LlumarPage.jsx'],
  ...
  ['/brands/solar-gard',                    '/src/pages/brands/SolarGardPage.jsx'],
  ['/brands/nexfil',                        '/src/pages/brands/NexfilPage.jsx'],
  ...
  ['/day-and-night-privacy-window-film',  '/src/pages/informational/DayAndNightPrivacyFilm.jsx'],
  ['/electric-privacy-film-arizona',      '/src/pages/informational/ElectricPrivacyFilm.jsx'],
  ['/privacy-film-sliding-glass-door',    '/src/pages/informational/PrivacyFilmSlidingGlassDoor.jsx'],
  ['/solyx-bird-safety-film',             '/src/pages/informational/SolyxBirdSafetyFilm.jsx'],
  ['/window-film-distributor-phoenix',    '/src/pages/informational/WindowFilmDistributorPhoenix.jsx'],
  ['/ai-window-film-estimator',           '/src/pages/AIWindowFilmEstimator.jsx'],
  ['/window-film-faq',                   '/src/pages/WindowFilmFAQ.jsx'],
  ['/window-film-comparison',            '/src/pages/WindowFilmComparison.jsx'],
  ['/window-film-resource-hub',          '/src/pages/WindowFilmResourceHub.jsx'],
