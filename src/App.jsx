...
const Blog = lazy(() => import('@/pages/Blog')); // This now refers to BlogPage
...
const globalSchema = {
	...
	"potentialAction": {
		"@type": "SearchAction",
		"target": "https://arizonahouseoffilm.com/search?q={search_term_string}",
...
function AnimatedRoutes() {
	...
	return (
		<AnimatePresence mode="wait">
			<Suspense fallback={<div className="w-full h-screen flex items-center justify-center"><div className="animate-spin rounded-full h-32 w-32 border-b-2 border-gray-900"></div></div>}>
...
function App() {
	const location = useLocation();
	const canonicalUrl = `https://arizonahouseoffilm.com${location.pathname.split('?')[0]}`;
	return (
		<>
			<Helmet>
				<html lang="en" />
				<title>Window Film Installation | Arizona House of Film | Phoenix, AZ</title>
				<meta name="description" content="Professional residential and commercial window film installation across Arizona — heat rejection, UV protection, and energy savings." />
