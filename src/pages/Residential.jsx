        ...
        <section className="py-12 bg-slate-800 border-b border-slate-700">
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <p className="text-gray-300 text-base md:text-lg leading-relaxed font-medium">
              Protect your Arizona home from one of the harshest climates in North America. Arizona House of Film installs residential window film across Phoenix, Scottsdale, Mesa, Chandler, Tempe, Gilbert, and 100+ Arizona cities. Our ceramic films block 84% of solar heat and 99.9% of UV rays — without compromising your view or darkening your rooms. Licensed ROC #314088. Read our <Link to="/blog/solar-window-film-phoenix-az" className="text-green-400 hover:text-green-300 underline">solar window film Phoenix</Link> guide, our <Link to="/blog/residential-performance-window-film-phoenix" className="text-green-400 hover:text-green-300 underline">residential performance window film Phoenix</Link> guide, our <Link to="/blog/security-window-film-phoenix-cost-guide" className="text-green-400 hover:text-green-300 underline">home security film cost guide</Link>, or our <Link to="/blog/window-tinting-queen-creek-guide" className="text-green-400 hover:text-green-300 underline">Queen Creek residential window film guide</Link> for neighborhood-specific recommendations.
            </p>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-6 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-3">
              {cities.map(city => {
                ...
                return (
                <Link key={city.slug} to={to} className="px-6 py-2 bg-white border border-gray-200 rounded-full text-sm font-bold text-slate-600 hover:border-green-500 hover:text-green-600 hover:shadow-md transition-all">
                  {city.name}
                </Link>
                );
              })}
