...
const Contact = () => {
  ...
  const faqSchema = {
    ...
    "mainEntity": [{
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes, we are a fully licensed Arizona Registrar of Contractors holder, ROC #315259."
      }
    }]
  };
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Get a free estimate for residential or commercial window tinting. Serving Phoenix & Scottsdale. Call 480-788-1591 today for a solar or security audit." />
      ...
      <main className="bg-[#020617] min-h-screen">
        {/* Header Section: Matches the "Get in Touch" Gradient background */}
        ...
        {/* Content Section: Uses Flexbox to prevent breaking on Large/Ultra-wide screens */}
        <section className="relative z-10 pb-24 px-4 sm:px-6">
          <div className="max-w-6xl mx-auto">
            <div className="flex flex-col lg:flex-row gap-8 items-stretch">
              
              {/* Sidebar Info (The Vertical Pill Towers) */}
              <aside className="w-full lg:w-[320px] xl:w-[380px] flex-shrink-0 bg-white/5 p-6 rounded-sm border border-white/10 lg:border-none">
                <ContactInfo />
              </aside>
              
              {/* Main White Form Container */}
              <div className="flex-grow bg-white p-8 md:p-12 shadow-2xl rounded-sm border border-gray-100">
                <div className="mb-8">
                  <h2 className="text-2xl font-black text-slate-900 uppercase tracking-tighter">
                    REQUEST YOUR <span className="text-blue-600 italic font-black">FREE AUDIT</span>
                  </h2>
                ...
                {/* Internal layout for form text vs fields */}
                <div className="flex flex-col xl:flex-row gap-12">
                  <div className="xl:w-1/3">
                    ...
                    <ul className="space-y-4">
                      {['Free consultation and measurement', 'Detailed quote within 24 hours', 'Licensed, bonded, and insured', 'Professional installation guarantee'].map((item) => (
                        <li key={item} className="flex items-center gap-3 text-[11px] font-black uppercase tracking-tight text-slate-800">
        ...
        {/* Local SEO Section: Service Area & Map */}
        ...
        <footer className="bg-black py-6 text-center border-t border-white/5">
          <p className="text-[10px] text-slate-500 font-black uppercase tracking-[0.4em]">
            Arizona House of Film • ROC #315259 • Phoenix Specialists
          </p>
        </footer>
      </main>
    </>
