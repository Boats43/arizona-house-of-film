...
import { 
  Home, Sun, Shield, Thermometer, Eye, 
  DollarSign, ArrowRight, Phone, CheckCircle 
} from 'lucide-react';
...
const Residential = () => {
  ...
  const benefits = [
    {
      ...
      title: 'UV Protection',
      slug: 'uv-protection',
      description: 'Block up to 99.9% of harmful UV rays that cause furniture fading and skin damage while maintaining natural light.'
    },
    {
      icon: DollarSign,
      title: 'Energy Savings',
      slug: 'energy-savings',
      description: 'Reduce your AC cooling costs by up to 30% with our high-performance ceramic residential window films.'
    },
    {
      icon: Eye,
      title: 'Enhanced Privacy',
      slug: 'enhanced-privacy',
      description: 'Enjoy daytime privacy while maintaining your view of the outdoors with our advanced one-way visibility films.'
    },
    {
      icon: Thermometer,
      title: 'Temperature Control',
      slug: 'temperature-control',
      description: 'Eliminate hot spots and maintain consistent temperatures throughout your home for total year-round comfort.'
    },
    {
      icon: Shield,
      title: 'Glare Reduction',
      slug: 'glare-reduction',
      description: 'Reduce annoying glare on TV screens and monitors while preserving your beautiful Arizona views.'
    },
    {
      icon: Home,
      title: 'Increased Comfort',
      slug: 'increased-comfort',
      description: 'Create a cooler living environment by reducing total solar heat gain by up to 78%.'
    }
  ];

  const filmTypes = [
    {
      name: 'Ceramic Solar Films',
      link: '/energy-saving-window-films',
      description: 'Highest heat rejection without the "mirror" look.',
      features: ['Extreme Heat Rejection', 'Non-Reflective', 'GPS/Signal Friendly', 'Lifetime Warranty']
    },
    {
      name: 'Privacy & Decorative',
      link: '/decorative-window-films',
      description: 'Style meets function for bathrooms and entryways.',
      features: ['Frosted Options', 'Textured Designs', 'Daytime Privacy', 'Custom Patterns']
    },
    {
      name: 'Safety & Security',
      link: '/safety',
      description: 'Hold glass together during impact or break-in attempts.',
      features: ['Thick 8mil+ Film', 'Impact Resistant', 'Crystal Clear', 'UV Blocking']
    }
  ];
  ...
  const serviceSchema = {
    ...
    "description": "Professional residential window tinting services providing UV protection, energy savings, and heat control."
  };
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {benefits.map((benefit, idx) => (
              <motion.div 
                key={idx} 
                whileHover={{ y: -5 }}
                className="p-8 rounded-3xl border border-gray-100 bg-slate-50 hover:bg-white hover:shadow-2xl transition-all group"
              >
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="space-y-12">
                {[
                  ...
                  <div key={i} className="flex gap-8">
                    <span className="text-5xl font-black text-slate-200 group-hover:text-green-500/20 transition-colors">{step.n}</span>
                    <div>
            ...
            <div className="relative">
              <img 
                src="https://horizons-cdn.hostinger.com/500f9a0e-19d5-4ed7-98ea-cc353ce878bb/20250821_144115-zLE7k.jpg" 
                alt="Installer working" 
                className="rounded-3xl shadow-2xl relative z-10"
              />
              <div className="absolute -bottom-6 -right-6 w-64 h-64 bg-green-500/10 rounded-full z-0 blur-3xl" />
            </div>
          </div>
        </div>
      </section>

      {/* --- SERVICE AREAS (The Loop) --- */}
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {cities.map(city => (
              <Link 
                ...
                className="px-6 py-2 bg-white border border-gray-200 rounded-full text-sm font-bold text-slate-600 hover:border-green-500 hover:text-green-600 hover:shadow-md transition-all"
              >
                {city.name}
              </Link>
            ))}
