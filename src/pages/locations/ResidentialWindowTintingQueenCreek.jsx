        ...
        <section className="py-14 bg-slate-900 border-t border-slate-800">
          <div className="max-w-5xl mx-auto px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              ...
              <Link to="/commercial-window-tinting-queen-creek" className="border border-slate-700 rounded-lg p-4 text-green-400 font-semibold hover:border-green-500 transition-colors">Queen Creek Commercial Window Film →</Link>
