...
const ROUTES = [
  ...
  '/scottsdale-window-tinting',
  '/mesa-window-tinting',
  '/chandler-window-tinting',
  '/gilbert-window-tinting',
  '/glendale-window-tinting',
  '/tempe-window-tinting',
  '/peoria-window-tinting',
  '/surprise-window-tinting',
  '/goodyear-window-tinting',
  '/tucson-window-tinting',
  '/flagstaff-window-tinting',
  '/prescott-window-tinting',
  '/yuma-window-tinting',
  '/avondale-window-tinting',
  '/buckeye-window-tinting',
  '/queen-creek-window-tinting',
  '/san-tan-valley-window-tinting',
  '/fountain-hills-window-tinting',
  '/paradise-valley-window-tinting',
  '/cave-creek-window-tinting',
  '/anthem-window-tinting',
  '/laveen-window-tinting',
  '/ahwatukee-window-tinting',
  '/prescott-valley-window-tinting',
  '/maricopa-window-tinting',
  '/apache-junction-window-tinting',
  '/casa-grande-window-tinting',
  '/el-mirage-window-tinting',
  '/florence-window-tinting',
  '/gold-canyon-window-tinting',
  '/litchfield-park-window-tinting',
  '/new-river-window-tinting',
  '/rio-verde-window-tinting',
  '/sun-city-window-tinting',
  '/sun-city-west-window-tinting',
  '/sun-lakes-window-tinting',
  '/tolleson-window-tinting',
  '/youngtown-window-tinting',
  '/sedona-window-tinting',
  '/cottonwood-window-tinting',
  '/camp-verde-window-tinting',
  '/clarkdale-window-tinting',
  '/jerome-window-tinting',
  '/lake-havasu-city-window-tinting',
  '/kingman-window-tinting',
  '/bullhead-city-window-tinting',
  '/payson-window-tinting',
  '/globe-window-tinting',
  '/miami-window-tinting',
  '/show-low-window-tinting',
  '/pinetop-lakeside-window-tinting',
  '/winslow-window-tinting',
  '/holbrook-window-tinting',
  '/st-johns-window-tinting',
  '/eagar-window-tinting',
  '/springerville-window-tinting',
  '/safford-window-tinting',
  '/thatcher-window-tinting',
  '/willcox-window-tinting',
  '/benson-window-tinting',
  '/sierra-vista-window-tinting',
  '/bisbee-window-tinting',
  '/douglas-window-tinting',
  '/nogales-window-tinting',
  '/green-valley-window-tinting',
  '/sahuarita-window-tinting',
  '/vail-window-tinting',
  '/oro-valley-window-tinting',
  '/marana-window-tinting',
  '/catalina-foothills-window-tinting',
  '/picture-rocks-window-tinting',
  '/three-points-window-tinting',
  '/arivaca-window-tinting',
  '/tubac-window-tinting',
  '/patagonia-window-tinting',
  '/sonoita-window-tinting',
  '/elgin-window-tinting',
  '/wickenburg-window-tinting',
  '/congress-window-tinting',
  '/yarnell-window-tinting',
  '/black-canyon-city-window-tinting',
  '/dewey-humboldt-window-tinting',
  '/mayer-window-tinting',
  '/chino-valley-window-tinting',
  '/paulden-window-tinting',
  '/ash-fork-window-tinting',
  '/williams-window-tinting',
  '/grand-canyon-village-window-tinting',
  '/tusayan-window-tinting',
  '/page-window-tinting',
  '/kayenta-window-tinting',
  '/tuba-city-window-tinting',
  '/window-rock-window-tinting',
  '/chinle-window-tinting',
  '/ganado-window-tinting',
  '/parker-window-tinting',
  '/quartzsite-window-tinting',
  '/wellton-window-tinting',
  '/somerton-window-tinting',
  '/san-luis-window-tinting',
  '/gadsden-window-tinting',
  '/superior-window-tinting',
  '/kearny-window-tinting',
  '/hayden-window-tinting',
  '/winkelman-window-tinting',
  '/coolidge-window-tinting',
  '/eloy-window-tinting',
  '/arizona-city-window-tinting',
