      ...
      {isCartOpen && (
        ...
        >
          <motion.div
            ...
            className="absolute right-0 top-0 h-full w-full max-w-md bg-gray-900/95 backdrop-blur-md shadow-2xl flex flex-col"
            ...
            <div className="flex-grow p-6 overflow-y-auto space-y-4">
              {cartItems.length === 0 ? (
                <div className="text-center text-gray-400 h-full flex flex-col items-center justify-center">
                  <ShoppingCartIcon size={48} className="mb-4 opacity-60" />
                ...
                cartItems.map(item => (
                  <div
                    key={item.variant.id}
                    className="flex items-center gap-4 bg-white/10 border border-white/10 rounded-lg p-3 hover:bg-white/15 transition"
                  >
                    <img
