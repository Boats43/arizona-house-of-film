    ...
    <main>
      ...
      <section className="bg-white py-12 border-b border-gray-100">
        <div className="container mx-auto px-4 sm:px-6 grid grid-cols-2 md:grid-cols-5 gap-8">
          {[
            { icon: Star, text: "Top Rated Google", sub: "30 Google Reviews" },
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="text-center mb-10">
            <p className="text-gray-300 text-sm">
              ...
              Visit the <Link to="/window-film-resource-hub" className="text-green-400 hover:text-green-300 underline font-semibold">Window Film Resource Hub</Link> — the complete Arizona guide ·{' '}
