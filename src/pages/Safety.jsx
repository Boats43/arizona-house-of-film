...
import { 
  Shield, AlertTriangle, Building, Eye, 
  ArrowRight, Phone, Wind, CheckCircle2
} from 'lucide-react';
...
const Safety = () => {
  ...
  return (
    <>
      <Helmet>
        <title>#1 Safety & Security Film in Arizona | Arizona House of Film</title>
        <meta name="description" content="Expert safety & security film installation across Arizona—deter break-ins, prevent storm damage, and protect your property with industrial laminates." />
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
            <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }}>
              ...
              <div className="flex flex-wrap gap-4">
                {/* Contrast Fix: Black text on White button */}
              ...
              {benefits.map((benefit, index) => (
                ...
                >
                  <Link to={`/safety/${benefit.slug}`} className="block h-full bg-slate-50 p-10 border-l-8 border-slate-200 group-hover:border-red-600 transition-all shadow-sm hover:shadow-xl">
                    ...
                    <h3 className="text-2xl font-black text-slate-950 mb-4 uppercase italic tracking-tight">
                      {benefit.title}
                    </h3>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div>
                <h2 className="text-4xl md:text-6xl font-black mb-8 uppercase italic tracking-tighter leading-none">
                  Laminate <br/><span className="text-red-600 font-outline">Performance</span>
                </h2>
              ...
              <div className="relative">
                <img 
                  ...
                  alt="Industrial Security Film Installation" 
                  className="rounded-none border-4 border-slate-800 grayscale hover:grayscale-0 transition-all duration-700"
                />
                <div className="absolute -bottom-6 -right-6 bg-red-600 p-8 text-white font-black uppercase italic leading-none hidden md:block">
                  Force Entry <br/> Resistant
                </div>
              </div>
            </div>
          </div>
