...
export default function WindowTintingQueenCreek() {
  ...
  return (
    <>
      <Helmet>
        <title>Window Tinting Queen Creek AZ | Residential & Commercial | Arizona House of Film</title>
      ...
      <div className="bg-slate-900 text-white py-16 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex items-center gap-3 mb-8">
            ...
            <span className="text-gray-300 text-sm">4.4 Google Rating · ROC #314088 · Since 2017</span>
          </div>
      ...
      <div className="max-w-5xl mx-auto px-4 py-12">
        ...
        <section className="mb-12 bg-blue-50 border border-blue-100 rounded-2xl p-8">
          <div className="flex items-center gap-2 mb-3">
            ...
            <h2 className="font-bold text-gray-800">Also Serving the Southeast Valley & Beyond</h2>
          </div>
