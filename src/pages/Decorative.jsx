  ...
  const filmLibrary = [
    {
      ...
      description: 'Classic etched glass and white matte frost for total privacy.',
    ...
    },
    {
      ...
      description: 'Geometric and organic textures like rice paper and rain glass.',
      ...
      <main id="main-content">
        ...
        <section className="relative min-h-[70vh] flex items-center pt-24 bg-white overflow-hidden text-slate-900">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
            <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} className="max-w-3xl">
              {/* ACCESSIBILITY: Contrast darkened to slate-800 */}
              ...
              <p className="text-xl text-slate-700 mb-10 leading-relaxed font-medium">
                The applications are endless: conference rooms, lobbies, and glass partitions. Transform any glass surface into a design statement with high-end privacy.
              </p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              <div>
                ...
                <p className="text-xl text-slate-800 mb-10 leading-relaxed font-medium">
                  Our in-house designers create precision-cut graphics, company logos, and bespoke architectural patterns for commercial environments.
                </p>
                <div className="space-y-4">
                  {['Precision-cut logos', 'Custom-printed opaque graphics', 'Safety markings', 'Architectural branding'].map((item, i) => (
        ...
        <section className="py-20 bg-slate-50 border-t border-slate-200">
          <div className="max-w-7xl mx-auto px-6 text-center">
            {/* ACCESSIBILITY: Darkened text-slate-600 */}
        ...
        <section className="py-24 bg-slate-950 text-white">
          <div className="max-w-4xl mx-auto px-6 text-center">
            <h2 className="text-5xl md:text-7xl font-black mb-10 uppercase italic">Elevate Your View</h2>
